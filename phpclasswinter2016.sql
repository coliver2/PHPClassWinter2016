...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 25, 2016 at 02:20 AM
...
CREATE TABLE IF NOT EXISTS `test` (
  `id` int(11) NOT NULL,
  `dataone` varchar(200) COLLATE utf8_bin NOT NULL,
  `datatwo` varchar(200) COLLATE utf8_bin NOT NULL
...
(1, 'test@test.com', 'a94a8fe5ccb19ba61c4c0873d391e987982fbbd3', '2016-02-10 00:00:00');
